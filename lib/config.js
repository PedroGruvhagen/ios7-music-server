...
const DEFAULT_CONFIG = {
  ...
  // Named pipe a local shairport-sync instance writes raw PCM to when
  // someone AirPlays audio to this machine. See lib/livecast.js.
  airplayPipe: '/tmp/shairport-sync-audio'
};
